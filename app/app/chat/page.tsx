    ...
    <div className="max-w-4xl mx-auto px-6 py-8 flex flex-col" style={{ height: 'calc(100vh - 7.5rem)' }}>
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-1.5 text-xs text-purple-400">
          <div className="w-2 h-2 rounded-full bg-purple-400" />Venice AI · Zero Retention
        </div>
      </div>
      ...
      <div className="flex gap-1 mb-4 border-b border-gray-800 pb-px">
        <button onClick={() => setTab('chat')}
          className={`px-4 py-2 text-sm font-medium transition border-b-2 -mb-px ${tab === 'chat' ? 'border-purple-500 text-white' : 'border-transparent text-gray-500 hover:text-gray-300'}`}>
          Chat with Advisor
        </button>
        <button onClick={() => setTab('connect')}
          className={`px-4 py-2 text-sm font-medium transition border-b-2 -mb-px ${tab === 'connect' ? 'border-purple-500 text-white' : 'border-transparent text-gray-500 hover:text-gray-300'}`}>
          Connect Your Agent
        </button>
      </div>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
            ...
            <div className="flex items-center justify-center gap-3 mb-6 py-4">
              <div className="text-center">
                <div className="w-12 h-12 rounded-full bg-indigo-500/20 border border-indigo-500/30 flex items-center justify-center mx-auto mb-2">
              ...
              <div className="text-center">
                <div className="w-12 h-12 rounded-full bg-purple-500/20 border border-purple-500/30 flex items-center justify-center mx-auto mb-2">
                  <span className="text-sm font-bold text-purple-400">DeFi</span>
                </div>
