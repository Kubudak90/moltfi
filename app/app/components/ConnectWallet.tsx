...
export function ConnectWallet() {
  ...
  if (!mounted) {
    return (
      <button className="bg-indigo-600 hover:bg-indigo-500 text-sm px-4 py-1.5 rounded-lg transition font-medium">
        Connect Wallet
      </button>
    )
  }
    ...
    return (
      <div className="relative" ref={menuRef}>
        <button
          ...
          className="flex items-center gap-2 bg-gray-800 hover:bg-gray-700 text-sm px-3 py-1.5 rounded-lg border border-gray-700 transition"
        >
