        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
            ...
            <p className="text-sm text-gray-400">
              Guardrails are smart contracts, not software settings. Max trade size, daily cap, approved tokens — all enforced on-chain. If the agent exceeds limits, the transaction reverts automatically. No exceptions.
            </p>
          </div>
