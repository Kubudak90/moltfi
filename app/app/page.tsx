  ...
  return (
    <div className="min-h-[calc(100vh-3.5rem)]">
      ...
      <section className="relative overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-jpm/15 rounded-full blur-[120px] -z-10" />

        <div className="max-w-4xl mx-auto px-6 pt-24 pb-20 text-center">
          <div className="inline-flex items-center gap-2 bg-jpm/10 border border-jpm/20 rounded-full px-4 py-1.5 mb-6">
            <div className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
            <span className="text-sm text-uni-light">Live on Base · Powered by Venice AI</span>
          </div>

          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            DeFi infrastructure<br />
            <span className="text-uni">for AI agents.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-20">
            <Link href="/dashboard"
              className="bg-jpm hover:bg-jpm px-8 py-3 rounded-lg text-lg font-medium transition">
              Open Dashboard
            </Link>
            <a href="https://github.com/ortegarod/moltfi" target="_blank" rel="noopener"
              className="border border-navy-600 hover:border-gray-500 px-8 py-3 rounded-lg text-lg font-medium transition">
              View on GitHub
            </a>
          </div>
        </div>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-20">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-navy-800 border border-jpm/30 rounded-xl p-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-lg bg-jpm flex items-center justify-center text-sm font-bold">You</div>
              <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li className="flex gap-2"><span className="text-uni">→</span> Knows you, your goals, your risk tolerance</li>
              <li className="flex gap-2"><span className="text-uni">→</span> You talk to it in plain English</li>
              <li className="flex gap-2"><span className="text-uni">→</span> It decides when and what to trade</li>
              <li className="flex gap-2"><span className="text-uni">→</span> Calls MoltFi&apos;s API to execute</li>
            </ul>
          </div>

          <div className="bg-navy-800 border border-uni/30 rounded-xl p-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-lg bg-jpm flex items-center justify-center text-sm font-bold">AG</div>
              <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li className="flex gap-2"><span className="text-gold">→</span> Knows DeFi — Uniswap, Lido, yields, gas</li>
              <li className="flex gap-2"><span className="text-gold">→</span> Analyzes markets privately via Venice</li>
              <li className="flex gap-2"><span className="text-gold">→</span> Executes trades through on-chain guardrails</li>
              <li className="flex gap-2"><span className="text-gold">→</span> Can never exceed your limits — blockchain enforces it</li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-navy-800 border border-navy-600 rounded-xl p-6">
          <div className="flex items-center justify-between max-w-2xl mx-auto text-center">
            ...
            <div className="flex-1">
              <div className="text-sm font-medium text-uni mb-1">Your Agent</div>
              <div className="text-xs text-gray-500">Reads skill, calls API</div>
            </div>
            <div className="text-gray-600 px-2">→</div>
            <div className="flex-1">
              <div className="text-sm font-medium text-gold mb-1">DeFi Agent</div>
              <div className="text-xs text-gray-500">Venice AI · zero retention</div>
            </div>
            <div className="text-gray-600 px-2">→</div>
            <div className="flex-1">
              <div className="text-sm font-medium text-emerald-400 mb-1">Blockchain</div>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-20">
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-navy-800 border border-navy-600 rounded-xl p-6">
            <div className="w-10 h-10 rounded-lg bg-jpm/20 flex items-center justify-center mb-4">
              <svg className="w-5 h-5 text-uni" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <section className="max-w-4xl mx-auto px-6 pb-20">
        ...
        <div className="bg-navy-800 border border-jpm/30 rounded-xl p-8 mb-8">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <div className="text-xs text-uni uppercase tracking-wider mb-3 font-medium">One skill file. Any agent.</div>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center gap-2 text-gray-300">
                  <span className="text-emerald-400">✓</span> OpenClaw agents
                </div>
                <div className="flex items-center gap-2 text-gray-300">
                  <span className="text-emerald-400">✓</span> Any agent with HTTP access
                </div>
                <div className="flex items-center gap-2 text-gray-300">
                  <span className="text-emerald-400">✓</span> No SDK, no library, no dependency
                </div>
                <div className="flex items-center gap-2 text-gray-300">
                  <span className="text-emerald-400">✓</span> Works in 60 seconds
                </div>
              </div>
            </div>
            <div>
              <div className="bg-navy-700/80 rounded-lg p-4 font-mono text-xs leading-relaxed">
                <div className="text-gray-500 mb-2"># Your agent does this once:</div>
                <div className="text-emerald-400">curl https://moltfi.app/api/skill</div>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-20">
        ...
        <div className="space-y-4 max-w-2xl mx-auto">
          {[
            ...
            <div key={item.step} className="flex gap-4 bg-navy-800 border border-navy-600 rounded-xl p-5">
              <div className="w-8 h-8 rounded-full bg-jpm flex items-center justify-center text-sm font-bold shrink-0">{item.step}</div>
              <div>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            { name: 'Venice AI', desc: 'Zero-retention private inference', color: 'border-uni/30' },
            ...
            { name: 'Celo', desc: 'Multi-chain stablecoin data', color: 'border-emerald-500/30' },
            { name: 'OpenClaw', desc: 'Agent runtime & harness', color: 'border-orange-500/30' },
            { name: 'ERC-8004', desc: 'On-chain agent identity', color: 'border-gold/30' },
          ].map(item => (
            <div key={item.name} className={`bg-navy-800 border ${item.color} rounded-xl p-4`}>
        ...
        <div className="bg-navy-800 border border-navy-600 rounded-xl p-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center text-xs">
            <a href="https://sepolia.basescan.org/address/0x63649f61F29CE6dC9415263F4b727Bc908206Fbc"
              target="_blank" rel="noopener" className="text-uni hover:underline font-mono">
      ...
      {/* Footer */}
      <footer className="border-t border-navy-600 py-8 text-center">
        <p className="text-sm text-gray-500 mb-2">
          Built by <a href="https://moltbook.com/u/Kyro" className="text-uni">Kyro</a> (AI agent) &amp;{' '}
          <a href="https://x.com/ortegarod01" className="text-uni">Rodrigo Ortega</a> (human)
        </p>
        <p className="text-xs text-gray-600">
          <a href="https://openclaw.ai" className="text-uni/70">OpenClaw</a>
          {' · '}<a href="https://venice.ai" className="text-uni/70">Venice AI</a>
          {' · '}The Synthesis 2026
        </p>
      </footer>
    </div>
