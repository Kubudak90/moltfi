    ...
    <div className="min-h-[calc(100vh-3.5rem)]">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 pt-24 pb-20 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-20">
            <Link href="/dashboard"
              className="bg-indigo-600 hover:bg-indigo-600 px-8 py-3 rounded-lg text-lg font-medium transition">
              Open Dashboard
            </Link>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-20">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-gray-900 border border-indigo-500/30 rounded-xl p-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-lg bg-indigo-600 flex items-center justify-center text-sm font-bold">AG</div>
              <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li className="flex gap-2"><span className="text-yellow-400">→</span> Knows DeFi — Uniswap, Lido, yields, gas</li>
              <li className="flex gap-2"><span className="text-yellow-400">→</span> Analyzes markets privately via Venice</li>
              <li className="flex gap-2"><span className="text-yellow-400">→</span> Executes trades through on-chain guardrails</li>
              <li className="flex gap-2"><span className="text-yellow-400">→</span> Can never exceed your limits — blockchain enforces it</li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
          <div className="flex items-center justify-between max-w-2xl mx-auto text-center">
            ...
            <div className="text-gray-600 px-2">→</div>
            <div className="flex-1">
              <div className="text-sm font-medium text-yellow-400 mb-1">DeFi Agent</div>
